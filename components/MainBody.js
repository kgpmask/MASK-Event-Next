			...
			<div className={Styles["card"]}>
				...
				<div className={Styles["content"]}>
					<p className={Styles["questions"]}>
						In the anime &quot;Naruto,&quot; what is the name of Naruto&quot;s
						signature jutsu that creates multiple copies of himself?
					</p>
					{isQuizStarted ? (
						!isQuestionAnswered &&
						(isTypeOptions ? (
								...
								<div className={Styles["options"]}>
									{options.map((item, index) => (
										<button key={index} className={Styles["option-button"]}>
											<span className={Styles["option-numbering"]}>
												{item.numbering}
											</span>
											{item.option}
										</button>
						...
						<div className={Styles["start-quiz"]}>
							<button className={Styles["start-quiz-nav"]}>Previous</button>
							<button
							...
							<button className={Styles["start-quiz-nav"]}>Next</button>
						</div>
					)}
					{isQuestionAnswered &&
						(isTypeOptions ? (
							<div className={Styles["answered-option"]}>
								<p
									className={Styles["option-button"]}
									style={{ width: "100%", cursor: "grab", color: "black" }}
								>
									<span className={Styles["option-numbering"]}>
										{options[0].numbering}
									</span>
