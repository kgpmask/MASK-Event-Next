      ...
      <TextArea title="Instructions">
        <div className={styles["instructions"]}>
          ...
          <ul>
            ...
            <li>
              <p>
                Each question is scored out of 100 points, except for the last
                round.
              </p>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                interface, it can only be seen on this PPT.
              </p>
            </li>
            <li>
              <p>
              ...
              <ol type="a">
                <li>
                  <p>MCQ-based questions: 30 seconds.</p>
                </li>
                <li>
                  <p>Text-based questions: 60 seconds.</p>
                </li>
              </ol>
            </li>
            <li>
              <p>
                In text-based, there will be partial marking for typing errors.
                As the given answer deviates from the actual answer, lesser
